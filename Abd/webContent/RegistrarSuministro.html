...
<html>
	...
	<body>
		...
		<div id="divForm">
			<form method="post" action="solicitarSuministro.php" enctype="multipart/form-data">
				<div id="divDatosSuministro">
					<fieldset>
						<legend>Datos de la tienda</legend>
						<div id="divCamposSuministro">
					...
					<fieldset>
						...
						<div id="divArticulosSuministro" class="divProductos">
