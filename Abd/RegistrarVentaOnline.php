...
<head>
	...
	<title>Registrar venta online</title>
</head>
<body>
Registrar venta online!
<div id="divForm">
	<form method="post" action="solicitarVentaOnline.php" enctype="multipart/form-data">
		<div id="divDatosVentaOnline">
			<fieldset>
				<legend>Datos del almacen</legend>
				<div id="divCamposVentaOnline">
			...
			<fieldset>
				...
				<div id="divArticulosVentaOnline" class="divProductos">
